function init() {
    ...
    console.log(`vertexShaderTextureUnit:${vertexShaderTextureUnit}`);
    console.log(`shaderTextureUnit:${shaderTextureUnit}`);
    console.log(`totalTextureUnit:${totalTextureUnit}`);
